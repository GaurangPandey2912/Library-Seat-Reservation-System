...
import { getFirestore, collection, addDoc, getDocs, setDoc, getDoc, doc, updateDoc, onSnapshot } from "firebase/firestore";
...
export { db, collection, addDoc, getDocs, doc, setDoc, getDoc, updateDoc, onSnapshot, app, auth };
